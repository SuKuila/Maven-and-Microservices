...
public static void main(String[] args) {
	...
	searchBankByIfsc("1234569");
	cacheTest1();
}

private static void cacheTest1() {
	EntityManager em=emf.createEntityManager();
	Bank b=em.find(Bank.class,"1234569");
	System.out.println(b.getBankName());
	//em.clear();
	Bank b2=em.find(Bank.class, "1234569");
...
static void searchBankByIfsc(String ifsc) {
	...
	if (b!=null) {
		System.out.println("Branch Name :"+b.getBranch());
		System.out.println("Bank Name :"+b.getBankName());
		List<BankCustomer> custs=b.getCustomer();
		System.out.println("Customers===");
		custs.forEach(c->System.out.println(c.getAccNo()+" "+c.getCustName()));
	}
}
